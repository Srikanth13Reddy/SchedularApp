...
public class ContactsListAdapter extends RecyclerView.Adapter<ContactsListAdapter.MyHolder>
{
    ...
    private ArrayList<ContactsModel> al;

    public ContactsListAdapter(Context context, ArrayList<ContactsModel> al) {
...
//        }
        ...
        holder.tv_ctime.setText(al.get(position).getNumber());
